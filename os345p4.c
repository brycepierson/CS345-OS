...
int P4_vmaccess(int argc, char* argv[])
{
	...
	printf("\nclockRPT = %#06x, clockUPT = %#06x, Pages = %d", clockRPT, clockUPT, accessPage(0, 0, PAGE_GET_SIZE));
	return 0;
} // end P4_vmaccess
...
int P4_8FramesTest(int argc, char* argv[])
{
    char* newArgs[2];
    newArgs[0] = "8";
    newArgs[1] = "8";
    P4_initMemory(2, newArgs);

    printf("\nShould = 3040:"); newArgs[1] = "0x3000"; P4_vmaccess(1, newArgs);
    printf("\nShould = 3041:"); newArgs[1] = "0x3001"; P4_vmaccess(1, newArgs);
    printf("\nShould = 3080:"); newArgs[1] = "0x3040"; P4_vmaccess(1, newArgs);
    printf("\nShould = 3081:"); newArgs[1] = "0x3041"; P4_vmaccess(1, newArgs);
    printf("\nShould = 3112:"); newArgs[1] = "0xEFD2"; P4_vmaccess(1, newArgs);
    printf("\nShould = 3191:"); newArgs[1] = "0xD851"; P4_vmaccess(1, newArgs);
    printf("\nShould = 31F3:"); newArgs[1] = "0xD833"; P4_vmaccess(1, newArgs);
    printf("\nShould = 30B3:"); newArgs[1] = "0x3873"; P4_vmaccess(1, newArgs); 	     // Runs clock
    printf("\nShould = 31C0:"); newArgs[1] = "0x3000"; P4_vmaccess(1, newArgs);
    printf("\nShould = 3145:"); newArgs[1] = "0xF7C5"; P4_vmaccess(1, newArgs);        // First page table swap
    printf("\nShould = 3130:"); newArgs[1] = "0xEFF0"; P4_vmaccess(1, newArgs);
    printf("\nShould = 3047:"); newArgs[1] = "0xD807"; P4_vmaccess(1, newArgs);
    printf("\nShould = 3100:"); newArgs[1] = "0x3040"; P4_vmaccess(1, newArgs);
    printf("\nShould = 3148:"); newArgs[1] = "0xFFC8"; P4_vmaccess(1, newArgs);
    printf("\nShould = 31FC:"); newArgs[1] = "0x303C"; P4_vmaccess(1, newArgs);
    printf("\nShould = 3040:"); newArgs[1] = "0xF000"; P4_vmaccess(1, newArgs);        // First old_write
